...
| SQLite/process durability contract | SQLITE-DUR-001 | `IN_PROGRESS` | integrated `1d67f87`, `b0c4b38`, `103c977`, `1dfd256`, `7cb58fa`, `02f91ce`, `f01b3c5`; ADR-0012, `docs/v1/SQLITE-DUR-001.md`, `reviews/15-sqlite-dur-adversarial-review.md`; one-owner/fixed-pool prototype plus 80 focused lock/WAL/SIGKILL/full-disk/latch/shutdown/fork/race tests | prior REJECT cycles were remediated through `02f91ce`; edge final REJECT cleanup/shutdown finding is remediated in `f01b3c5` pending independent commit-bound re-review, dual-runtime evidence and exact-host filesystem/Docker restart/power-interruption conformance |
