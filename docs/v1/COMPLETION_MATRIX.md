...
| SQLite/process durability contract | SQLITE-DUR-001 | `IN_PROGRESS` | integrated `1d67f87`, `b0c4b38`, `103c977`, `1dfd256`; ADR-0012, `docs/v1/SQLITE-DUR-001.md`, `reviews/15-sqlite-dur-adversarial-review.md`; one-owner/fixed-pool prototype plus 65 focused lock/WAL/SIGKILL/full-disk/latch/shutdown/fork tests | three role-based reviews rejected `0fff920`; code findings are remediated in `1dfd256` pending independent commit-bound re-review, dual-runtime evidence and exact-host filesystem/Docker restart/power-interruption conformance |
