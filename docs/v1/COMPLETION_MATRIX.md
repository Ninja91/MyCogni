...
| Network-deny proof | NET-001 | `IN_PROGRESS` | `docs/v1/NET-001-NETWORK-DENY.md`; 53 focused policy tests and dual-runtime lane evidence, followed by `reviews/09-net001-adversarial-review.md` REJECT | fix plugin coverage, lifecycle revocation, marker provenance, integrity coverage, descriptor/Unix-socket scope and probe diagnostics; independent re-review required |
