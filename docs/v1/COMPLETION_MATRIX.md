...
| Full traceability validator | GOV-001 | `IN_PROGRESS` | machine registries and adversarial fixtures plus `reviews/08-gov001-v4-adversarial-review.md` REJECT | fix staged branch-local approval trust, zero-base ref recreation and structural-witness overclaim; independent re-review required |
