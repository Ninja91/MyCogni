...
| Auth/key/egress/runner/browser/backup spikes | SPIKE-* | `IN_PROGRESS` | `1931d20`, `docs/v1/spikes/SPIKE-AUTH.md`, `reviews/12-spike-auth-adversarial-review.md`; 84 focused and 949 dual-runtime lane tests followed by product/operator REJECT | fix sibling recovery, sporadic recovery/rebootstrap, root/revoke authority, executable transcript and operator-retention gaps; then complete three-hat re-review; other spikes remain not started |
