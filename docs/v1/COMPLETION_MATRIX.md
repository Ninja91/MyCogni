...
| SQLite/process durability contract | SQLITE-DUR-001 | `IN_PROGRESS` | `0c29ca5`, `222060a`, `f4870b7`, ADR-0012, `docs/v1/SQLITE-DUR-001.md`; one-owner/connection prototype plus 48 focused lock/WAL/SIGKILL/full-disk/recovery tests | independent commit-bound review, dual-runtime evidence and exact-host filesystem/Docker restart/power-interruption conformance remain open |
